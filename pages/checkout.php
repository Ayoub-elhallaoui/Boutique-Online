    ...
    <section class="checkout spad">
        <div class="container">
            ...
            // function increment($id) {
                ...
                //     while ($k < $id) {
                    //         $som += $k;
                    //         $k++; // Incrémente $k pour éviter une boucle infinie
            //     }
            //     return $som; // Retourne la somme
            // }
            // var_dump(increment(1));
            if($orders){
                ...
                $tel = $_POST['tel'];
                $email = $_POST['email'];
                if(isset($name,$date,$address,$tel,$email)){
                    file_put_contents(
                        $orders,
                        "\norders_id,$name,$line[0],$line[7],$date,$address,$tel,$email",
                        FILE_APPEND
                    );
